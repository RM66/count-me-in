...
CREATE TABLE "time_slots" (
	...
	"ends_at" timestamp with time zone GENERATED ALWAYS AS (starts_at + make_interval(mins => duration_minutes)) STORED,
...
CREATE UNIQUE INDEX "organizers_phone_key" ON "organizers" USING btree ("phone");--> statement-breakpoint
