...
// ErrNoValuesToSet — drizzle raises the equivalent when an UPDATE
// carries no writable field; surfaced as a 500 like the TS route.
var ErrNoValuesToSet = errors.New("no values to set")
