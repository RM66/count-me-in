...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        /*
         * `react/prop-types` is a false positive here: these are inline
         * components whose props come from DayPicker's own generics, which the
         * rule cannot see. Scoped to this object rather than the file so real
         * violations elsewhere in `calendar.tsx` still surface.
         */
