...
const nav = [
  ...
  { title: 'Services', href: '/dashboard/services', icon: SparklesIcon },
  { title: 'Slots', href: '/dashboard/slots', icon: CalendarClockIcon },
  { title: 'Bookings', href: '/dashboard/bookings', icon: TicketIcon },
  { title: 'Analytics', href: '/dashboard/analytics', icon: BarChart3Icon },
