...
function generate(): void {
  ...
  // Shape parity guard: `en` defines the corpus shape (ADR-011); a
  // locale missing a key would silently fall back to English at
  // runtime. Fail the generation instead, so the gap is fixed at the
  // source.
